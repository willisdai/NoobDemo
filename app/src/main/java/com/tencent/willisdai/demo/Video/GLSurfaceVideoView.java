...
class GLSurfaceVideoView extends GLSurfaceView implements MediaPlayer.OnPreparedListener {
    ...
    private class VideoRender
        ...
        synchronized public void onFrameAvailable(SurfaceTexture surface) {
            ...
            if (!GLSurfaceVideoView.this.mFirstFrameRendered) {
                GLSurfaceVideoView.this.onFirstFrameRendered();
            }
        }
