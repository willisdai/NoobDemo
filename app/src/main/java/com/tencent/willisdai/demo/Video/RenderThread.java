...
public class  RenderThread extends Thread{
    ...
    private int compileShader(){
        ...
        String vertexShaderCode = readRawTextFile(TextureVideoActivity.getAppInstance(), R.raw.vertex);
        String fragmentShaderCode;

        fragmentShaderCode = readRawTextFile(TextureVideoActivity.getAppInstance(), R.raw.no_effect);
    ...
    private void startPreview(){
        ...
        TextureVideoActivity app = TextureVideoActivity.getAppInstance();
